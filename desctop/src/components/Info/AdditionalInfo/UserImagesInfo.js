...
import styles from '../FriendInfo/FriendInfo.module.css'
...
const UserImagesInfo = ({imagesUser}) => {
  ...
  return (
    <>
      ...
      <div className={styles.info_photos_wrap}>
        <p className={styles.info_photos_desc}>На стене</p>
        <button 
          className={styles.info_button_photos} 
          title='Фотографии' 
          disabled={!count}
          onClick={() => setPhotoToView(true)}
        >
